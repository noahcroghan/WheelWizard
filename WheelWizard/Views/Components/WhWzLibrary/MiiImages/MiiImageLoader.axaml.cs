...
public class MiiImageLoader : BaseMiiImage
{
    ...
    private static readonly StyledProperty<bool> HeightAsScalingReferenceProperty = AvaloniaProperty.Register<MiiImageLoader, bool>(
        nameof(HeightAsScalingReference),
        true
    );
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        Dispatcher.UIThread.Post(
            () =>
            {
                var newValue = HeightAsScalingReference ? miiImageContainer.Bounds.Height : miiImageContainer.Bounds.Width;
                if (loadingIcon != null)
